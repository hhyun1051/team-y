...
**파싱 규칙:**
1. 연락처 및 전화번호 정규화 규칙:
   - 02로 시작: 02-XXXX-XXXX (서울)
   - 031~064로 시작: 0XX-XXX-XXXX 또는 0XX-XXXX-XXXX (지역번호, 자릿수에 따라)
   - 010~019로 시작: 01X-XXXX-XXXX (휴대폰)
   - 15XX, 16XX, 18XX로 시작: XXXX-XXXX (대표번호)
   - 총 자릿수로 판단:
     - 10자리 → 3-3-4 (예: 0551234567 → 055-123-4567)
     - 11자리 → 3-4-4 (예: 01012345678 → 010-1234-5678)
     - 서울 10자리 → 2-4-4 (예: 0212345678 → 02-1234-5678)
